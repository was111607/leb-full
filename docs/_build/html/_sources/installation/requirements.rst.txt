...
* You must have an account with the beta version of Central EnteroBase, since this is a different server to the regular Central EnteroBase (https://enterobase.warwick.ac.uk), you must register a new account at: https://enterobase.warwick.ac.uk/auth/register.
